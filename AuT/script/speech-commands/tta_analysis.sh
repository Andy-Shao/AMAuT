...
# python -m AuT.speech_commands.tta_analysis --dataset 'speech-commands_v2' --dataset_root_path $BASE_PATH'/data' \
#     --output_csv_name 'tta_analysis.csv' --batch_size 32 --arch 'CT' --arch_level 'base' \
#     --original_auT_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-auT.pt' \
#     --original_auC_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-cls.pt' \
#     --original_auT2_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-auT2.pt' \
#     --original_auC2_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-cls2.pt' \
#     --original_auT3_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-auT3.pt' \
#     --original_auC3_weight_path './result/speech-commands_v2/AuT/train/CT-SC2-cls3.pt'
...
python -m AuT.speech_commands.fce_analysis --dataset 'speech-commands_v2' --dataset_root_path $BASE_PATH'/data' \
    ...
    --original_auC_weight_path './result/speech-commands_v2/AuT/train/FCE-SC2-cls.pt' --only_origin