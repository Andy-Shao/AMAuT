...
# python -m AuT.speech_commands.cons_analy --dataset 'speech-commands' --dataset_root_path $BASE_PATH'/data/speech_commands' \
...
python -m AuT.speech_commands.cons_analy --dataset 'speech-commands_v2' --dataset_root_path $BASE_PATH'/data' \
    --output_csv_name 'fce_analysis.csv' --batch_size 32 --arch 'FCE' --arch_level 'base' \
