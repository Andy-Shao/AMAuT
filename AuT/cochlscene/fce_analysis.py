...
from AuT.cochlscene.train import build_model
from AuT.speech_commands.fce_analysis import load_model
from AuT.vocalsound.fce_analysis import inference, aug_elect_inference, hybrid_inference, multi_train_inference
...
if __name__ == '__main__':
    ...
    test_dataset = CochlScene(root_path=args.dataset_root_path, mode='test', data_tf=tf_array, include_rate=False)
    ...
    aug_test_set = MultiTFDataset(
        dataset= CochlScene(root_path=args.dataset_root_path, mode='test', data_tf=None, include_rate=False),
        tfs=[
